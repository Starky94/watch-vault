...
import { importRecentlyReleasedGames } from './gameImportService.js'
...
async function run() {
  ...
  try {
    ...
    console.log(`Fetched ${result.fetchedCount} recently released games from IGDB. Inserted ${result.insertedCount} new games and refreshed ${result.updatedCount} existing games.`)
  } finally {
    await pool.end()
  }
}
